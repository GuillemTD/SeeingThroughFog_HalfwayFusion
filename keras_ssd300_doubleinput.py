...
#NEW: changes to Pierluigi Ferrari's SSD300.py version are marked with #NEW
'''
...
def ssd_300(image_size,
    ...
    # Build the network.
    ############################################################################
# NEW: a "_f1" indication has been add to ALL layers until pool3_f1
    x_f1 = Input(shape=(img_height, img_width, img_channels))
    # The following identity layer is only needed so that the subsequent lambda layers can be optional.
    x1_f1 = Lambda(identity_layer, output_shape=(img_height, img_width, img_channels), name='identity_layer_f1')(x_f1)
    conv1_1_f1 = Conv2D(64, (3, 3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv1_1_f1')(x1_f1)
    conv1_2_f1 = Conv2D(64, (3, 3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv1_2_f1')(conv1_1_f1)
    pool1_f1 = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same', name='pool1_f1')(conv1_2_f1)

    conv2_1_f1 = Conv2D(128, (3, 3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv2_1_f1')(pool1_f1)
    conv2_2_f1 = Conv2D(128, (3, 3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv2_2_f1')(conv2_1_f1)
    pool2_f1 = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same', name='pool2_f1')(conv2_2_f1)

    conv3_1_f1 = Conv2D(256, (3, 3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv3_1_f1')(pool2_f1)
    conv3_2_f1 = Conv2D(256, (3, 3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv3_2_f1')(conv3_1_f1)
    conv3_3_f1 = Conv2D(256, (3, 3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv3_3_f1')(conv3_2_f1)
    pool3_f1 = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same', name='pool3_f1')(conv3_3_f1)

#NEW: SECOND FLOW: from x_f2 to pool3_f2
    x_f2 = Input(shape=(img_height, img_width, img_channels))
    x1_f2 = Lambda(identity_layer, output_shape=(img_height, img_width, img_channels), name='identity_layer_f2')(x_f2)
    conv1_1_f2 = Conv2D(64, (3, 3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv1_1_f2')(x1_f2)
    conv1_2_f2 = Conv2D(64, (3, 3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv1_2_f2')(conv1_1_f2)
    pool1_f2 = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same', name='pool1_f2')(conv1_2_f2)

    conv2_1_f2 = Conv2D(128, (3, 3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv2_1_f2')(pool1_f2)
    conv2_2_f2 = Conv2D(128, (3, 3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv2_2_f2')(conv2_1_f2)
    pool2_f2 = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same', name='pool2_f2')(conv2_2_f2)

    conv3_1_f2 = Conv2D(256, (3, 3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv3_1_f2')(pool2_f2)
    conv3_2_f2 = Conv2D(256, (3, 3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv3_2_f2')(conv3_1_f2)
    conv3_3_f2 = Conv2D(256, (3, 3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv3_3_f2')(conv3_2_f2)
    pool3_f2 = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding='same', name='pool3_f2')(conv3_3_f2)

#NEW LAYERS: CONCATENATE + NIN POSITION
    #INPUT ARE: pool3_f1 & pool3_f2
    concate_flows = Concatenate(axis=3, name='concate_flows')([pool3_f1, pool3_f2])
    # NIN LAYER
    nin_flows = Conv2D(256, (1,1), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='nin_flows')(concate_flows)

#NEW: input conv_4_1 has to be changed to "nin_flows"
    
    conv4_1 = Conv2D(512, (3, 3), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv4_1')(nin_flows)
    ...
    if mode == 'training':
        # NEW: model has now two inputs, only works with "training" mode
        model = Model(inputs=[x_f1, x_f2], outputs=predictions)
    elif mode == 'inference':
